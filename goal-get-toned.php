...
<div class="w-container program-page" id="choose-your-goal">
    <div class="content page">
      <h2 class="page">Get Toned</h2>
      <div class="w-row">
        <div class="w-col w-col-6 w-col-small-6">
          <img src="images/MyTeam_Tone_2.jpg" alt="MyTeam_Tone_2.jpg">
          <div class="goal-bg green">
            <h4>Start date</h4>
            <p>February, 2014</p>
        ...
        <div class="w-col w-col-6 w-col-small-6 program-page">
          ...
          <p class="program-page">This program will help you get toned.</p>
          <h4 class="program-page">Who is it for?</h4>
          <p class="program-page">This course is designed for beginner and intermediate women.</p>
